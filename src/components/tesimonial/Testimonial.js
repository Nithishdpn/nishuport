...
//                       </h3>
//                       <p clas<div className="text-yellow-500 flex gap-1">
//                       <RiStarFill />
//                       <RiStarFill />
//                       <RiStarFill />
//                       <RiStarFill />
//                       <RiStarFill />
//                     </div>
//                   </div>sName="text-base text-gray-400 mt-3">
          ...
          <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
            ...
            <div className="w-full lgl:w-[60%] h-full flex flex-col justify-between">
              ...
              <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                ...
                <p className="text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. A dolorum, eos natus ipsum numquam veniam officia
                  necessitatibus ratione quos debitis exercitationem repudiandae facilis id neque nihil accusantium perspiciatis
                  repellat? Iste.
                </p>
              </div>
            </div>
            ...
            <div className="w-full lgl:w-[60%] h-full flex flex-col justify-between">
              ...
              <div className="w-full h-[70%] py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] rounded-lg shadow-shadowOne p-4 lgl:p-8 flex flex-col justify-center gap-4 lgl:gap-8">
                <div className="flex flex-col justify-between lgl:items-center py-6 border-b-2 border-b-gray-900">
                  <div>
                    <h3 className="text-xl lgl:text-2xl font-medium tracking-wide">Travel Mobile App Design.</h3>
                    {/* <p className="text-base text-gray-400 mt-3">via Upwork - Mar 4, 2015 - JUN 30, 2024 test</p> */}
                  </div>
                  <div className="text-yellow-500 flex gap-1">
                    <RiStarFill />
                    <RiStarFill />
                ...
                <p className="text-base font-titleFont text-gray-400 font-medium tracking-wide leading-6">
                I am a web developer who uses animation to add depth and enhance user experiences. My focus is on creating seamless, 
                intuitive interactions that simplify complex processes. By combining technical skills with a design-driven approach,
                 I bring digital projects to life in a visually engaging and functional way.
                </p>
              </div>
            </div>
          </div>
